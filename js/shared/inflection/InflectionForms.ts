...
addForm('m', 'nominative masculine', { gender: Gender.M, number: GrammarNumber.SINGULAR, grammaticalCase: GrammarCase.NOM })
addForm('f', 'nominative feminine', { gender: Gender.F, number: GrammarNumber.SINGULAR, grammaticalCase: GrammarCase.NOM })
addForm('n', 'nominative neuter', { gender: Gender.N, number: GrammarNumber.SINGULAR, grammaticalCase: GrammarCase.NOM })
addForm('pl', 'nominative plural', { number: GrammarNumber.PLURAL, grammaticalCase: GrammarCase.NOM })
addForm('fpl', 'feminine plural', { number: GrammarNumber.PLURAL, gender: Gender.F })
addForm('sg', 'singular', { number: GrammarNumber.SINGULAR })

addForm('nom', 'nominative', { grammaticalCase: GrammarCase.NOM, number: GrammarNumber.SINGULAR })
addForm('gen', 'genitive', { grammaticalCase: GrammarCase.GEN, number: GrammarNumber.SINGULAR })
addForm('dat', 'dative', { grammaticalCase: GrammarCase.DAT, number: GrammarNumber.SINGULAR })
addForm('acc', 'accusative', { grammaticalCase: GrammarCase.ACC, number: GrammarNumber.SINGULAR })
addForm('instr', 'instrumental', { grammaticalCase: GrammarCase.INSTR, number: GrammarNumber.SINGULAR })
addForm('prep', 'prepositional', { grammaticalCase: GrammarCase.PREP, number: GrammarNumber.SINGULAR })
addForm('loc', 'locative', { grammaticalCase: GrammarCase.LOC, number: GrammarNumber.SINGULAR })
...
addForm('genplalt', 'genitive plural alternative form', { grammaticalCase: GrammarCase.GEN, number: GrammarNumber.PLURAL })
addForm('datplalt', 'dative plural alternative form', { grammaticalCase: GrammarCase.DAT, number: GrammarNumber.PLURAL })
addForm('accplalt', 'accusative plural alternative form', { grammaticalCase: GrammarCase.ACC, number: GrammarNumber.PLURAL })
addForm('instrplalt', 'instrumental plural alternative form', { grammaticalCase: GrammarCase.INSTR, number: GrammarNumber.PLURAL })
addForm('prepplalt', 'prepositional plural alternative form', { grammaticalCase: GrammarCase.PREP, number: GrammarNumber.PLURAL })

addForm('genalt', 'genitive plural alternative form', { grammaticalCase: GrammarCase.GEN, number: GrammarNumber.SINGULAR })
addForm('datalt', 'dative plural alternative form', { grammaticalCase: GrammarCase.DAT, number: GrammarNumber.SINGULAR })
addForm('accalt', 'accusative plural alternative form', { grammaticalCase: GrammarCase.ACC, number: GrammarNumber.SINGULAR })
addForm('instralt', 'instrumental plural alternative form', { grammaticalCase: GrammarCase.INSTR, number: GrammarNumber.SINGULAR })
addForm('prepalt', 'prepositional plural alternative form', { grammaticalCase: GrammarCase.PREP, number: GrammarNumber.SINGULAR })
